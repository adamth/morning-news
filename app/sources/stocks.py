...
_REACTIONS: dict[str, dict[str, list[str]]] = {
    "bullish": {
        "mild": [
            ...
            "Everything's pointing the same direction for once, and it's up.",
            "A rare morning where the numbers are the good news.",
            "The watchlist had a better night than most of us.",
            "Up all round — enjoy it, these mornings are not the norm.",
            "Whatever the market ate for breakfast, it agreed with it.",
        ],
        "mature": [
            ...
            "All green. Don't let it go to your head, it never lasts.",
            "The watchlist is up and, for once, nobody has to lie about it.",
            "Everything gained. Enjoy the fifteen minutes before it undoes itself.",
            "Up across the board — a decent morning to be smug and quiet about it.",
            "Green everywhere. Statistically, this is the bit before the bit you regret.",
        ],
    },
    "bearish": {
        "mild": [
            ...
            "The watchlist is having a difficult morning; give it some room.",
            "All down. A good day to look at something else entirely.",
            "The market got out of bed badly and took the portfolio with it.",
            "Red across the board — nothing to be done about it before lunch.",
            "Down everywhere, which at least makes it simple to summarise.",
        ],
        "mature": [
            ...
            "All down. The market took one look at your holdings and kept walking.",
            "Everything's off. Close the app, eat something, deal with it later.",
            "A thorough kicking. No notes, no silver lining, just red.",
            "Down the lot of it — the kind of morning that funds someone else's boat.",
            "The watchlist got taken apart overnight. It happens; it'll happen again.",
        ],
    },
    "mixed": {
        "mild": [
            ...
            "The watchlist is arguing with itself again.",
            "Bit of both today, which is most days really.",
            "Some up, some down — the market is hedging on your behalf.",
            "No clear story this morning; the numbers went their separate ways.",
            "Split down the middle, like the last slice of anything in a shared house.",
        ],
        "mature": [
            ...
            "Some carried the team, some didn't turn up. You know which is which.",
            "Half of it worked. The other half is why you don't talk about this at parties.",
            "A draw, roughly — which is the market's way of wasting your time.",
            "Mixed. Whatever you tell yourself about this one, the average disagrees.",
            "Some up, some down, nobody covered in glory.",
        ],
    },
    "flat": {
        "mild": [
            ...
            "Almost nothing moved, which is its own kind of result.",
            "The numbers are where you left them yesterday.",
            "A quiet one. The watchlist has nothing to report.",
            "Practically unchanged — nothing to think about before breakfast.",
            "Still as a pond out there.",
        ],
        "mature": [
            ...
            "Nothing happened. You could have skipped this bit entirely.",
            "Unchanged. A whole day of trading to arrive back where it started.",
            "Flat as anything. Somebody got paid to produce this non-event.",
            "No movement worth the name — don't waste a thought on it.",
            "Absolutely nothing. The market phoned it in.",
        ],
    },
}
