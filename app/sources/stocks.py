...
def get_market_summary(
    ...
    *,
    ...
    return _build_summary(snapshots)
...
def _build_summary(snapshots: list[QuoteSnapshot]) -> MarketSummary:
    total = len(snapshots)
    ...
    reaction_hint = _pick_reaction(direction)
...
def _pick_reaction(direction: str) -> str:
    return random.choice(_REACTIONS.get(direction, _REACTIONS["mixed"]))
